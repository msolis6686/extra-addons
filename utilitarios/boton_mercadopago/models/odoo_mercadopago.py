...
class OdooMercadopago(models.AbstractModel):
    ...
    def mercadopago_create_preference(self):
        ...
        sdk = mercadopago.SDK("APP_USR-6189710633900427-070418-f4b618d7ffea6906b8d538e12ddfce2a-162428224")
        ...
        if mercadopago_client and mercadopago_key:
            for obj in self:
                ...
                preferenceResult = sdk.payment().create(preference)

                payment = preferenceResult["response"]
