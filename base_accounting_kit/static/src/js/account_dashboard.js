                    ...
                    window.myCharts = new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                {
                                    label: 'Ganancias/Pérdidas', // Name the series
        ...
        onclick_invoice_this_year: function (ev) {
            ...
            rpc.query({
                ...
                .then(function (result) {
                    ...
                    $('#total_customer_invoice_paid_current_year').append('<div class="logo">' + '<span>' + customer_invoice_paid_current_year + '</span><span>Total Conciliado<span></div>');
                    ...
                    $('#total_supplier_invoice_paid_current_year').append('<div" class="logo">' + '<span>' + supplier_invoice_paid_current_year + '</span><span>Total Conciliado<span></div>');
        ...
        onclick_invoice_this_month: function (ev) {
            ...
            rpc.query({
                ...
                .then(function (result) {
                    ...
                    $('#total_customer_invoice_paid_current_month').append('<div class="logo">' + '<span>' + customer_invoice_paid_current_month + '</span><span>Total Conciliado<span></div>');
                    ...
                    $('#total_supplier_invoice_paid_current_month').append('<div" class="logo">' + '<span>' + supplier_invoice_paid_current_month + '</span><span>Total Conciliado<span></div>');
            ...
            $.when(this._super())
                .then(function (ev) {
                    ...
                    $('#toggle-two').bootstrapToggle({
                        on: 'Todas las entradas',
                        off: 'Entradas publicadas'
                    });
                    ...
                    rpc.query({
                        ...
                        .then(function (result) {
                            ...
                            $('#total_invoices_last').append('<span>' + total_invoices_last_month + ' ' + currency + '</span><div class="title">Mes anterior</div>')
                        })
                    ...
                    rpc.query({
                        ...
                        .then(function (result) {
                            ...
                            $('#unreconciled_items_').append('<span>' + unreconciled_counts_ + ' Item(s)</span><div class="title">Este mes</div>')
                        })
                    rpc.query({
                        model: "account.move",
                        ...
                        .then(function (result) {
                            ...
                            $('#unreconciled_counts_this_year').append('<span>' + unreconciled_counts_this_year + '  Item(s)</span><div class="title">Este Año</div>')
                    ...
                    rpc.query({
                        ...
                        .then(function (result) {
                            ...
                            $('#total_incomes_last').append('<span>' + incomes_last + '</span><div class="title">Mes anterior</div>')
                        })
                    ...
                    rpc.query({
                        ...
                        .then(function (result) {
                            ...
                            $('#total_incomes_last_year').append('<span>' + incomes_last_year + '</span><div class="title">Año anterior</div>')
                        })
                    rpc.query({
                        model: "account.move",
                    ...
                    rpc.query({
                        ...
                        args: [posted],
                            ...
                            if (profit_this_months) {
                                ...
                                $('#net_profit_this_months').append('<div class="title">Ganancias/Pérdidas Neta &nbsp;&nbsp;&nbsp;</div><span>' + net_profit_this_months + '</span>')
                    ...
                    rpc.query({
                        ...
                        .then(function (result) {
                            ...
                            if (profit_this_year) {
                                ...
                                $('#net_profit_this_year').append('<div class="title">Ganancias/Pérdidas Neta &nbsp;&nbsp;&nbsp;</div><span>' + net_profit_this_year + '</span>')
